...
function module.sol1 ()
    ...
    for v in io.lines "input/day1/input.txt" do
        ...
        print( action, num, frequence )
    end

    print( ("Soluiton is: %d"):format( frequence ) )
end
...
local function findDuplicateFrequency ()
    local action
    local num
    local frequence = 0
    local lines = {}
    ...
    while true do
        for _, v in pairs(lines) do
            ...
            if not seenFrequencies[frequence] then
                seenFrequencies[frequence] = true
            else
                return frequence
            end
        end
...
function module.sol2 ()
    frequence = findDuplicateFrequency()
    print( ("Soluiton is: %d"):format( frequence ) )
end
